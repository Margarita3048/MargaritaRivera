...
**7.1.1. Hipótesis de anova**

**H0:** El estadío de maduración no tiene efecto sobre el índice gonadosomático.

**H1:** El estadío de maduración tiene efecto sobre el índice gonadosomático.


```{r}
mat <- lm(IGS ~ ESTADIO, data=data)
anova(mat)%>%kable(caption="Anova de una vía para el IGS en función del estadío de maduración", digits=2)
```

Con p=0 se rechaza la hipótesis nula, es decir que el estadío de maduración si tiene un efecto sobre el índice gonadosomático en machos de la cepa Lochy de _Salmo salar_.

**7.1.2. Supuestos de ANOVA**
...
ln: se acepta nula de que no hay correlación, p>0.05 entonces se cumple homocedasticidad, p <0.05 entonces no se cumple normalidad (puedo usar este con enfoque no parametrico) o puedo usar con la variable respuesta directamente la prueba no parametrica

log: si independencia, si homocedaticidad, no normalidad

sqrt: si independencia, no homocedaticidad, no normalidad

acos: si independencia, no homocedaticidad, no normalidad
...
IGSMADUROS>QUE PRA INMAUROS

**GREATER**

H0: EL IGS EN MADUROS ES  MENOR IGUAL AL IGS EN INMADUROS
H1: EL IGS EN MADUROS ES MAYOR QUE EN INAMDUROS

**Conclusión**: EL IGS EN MADUROS ES MAYOR QUE EN INAMDUROS
