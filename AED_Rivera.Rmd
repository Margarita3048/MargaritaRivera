...
**Logaritmo natural**: se acepta nula de que no hay correlación, p>0.05 entonces se cumple homocedasticidad, p <0.05 entonces no se cumple normalidad (puedo usar este con enfoque no parametrico) o puedo usar con la variable respuesta directamente la prueba no parametrica
